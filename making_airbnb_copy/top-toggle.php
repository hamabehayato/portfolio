    ...
    <div class="header-label-zone">
        ...
        <div class="header-width-pc-menu">
            <ul class="width-pc-menu-ul">
                ...
                <li class="width-pc-menu-li">
                    <button class="width-pc-button">ヘルプ</button>
                </li>
                <li class="width-pc-menu-li">
                    <button class="width-pc-button">登録する</button>
                </li>
                <li class="width-pc-menu-li">
                    <button class="width-pc-button">ログイン</button>
                </li>
                    ...
                    <li class="header-li">
                        <div class="header-a-zone header-a-zone-flex">
                            <a class="header-a" href="#">
                                ...
                                <article class="house"><img src="img/house.svg" alt=""></article>
                        </div>
                    </li>
                    <li class="header-li">
